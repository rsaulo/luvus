...
Ordinary pane output schedules CWD inspection for the changed pane and branch
inspection for its owning workspace. Attach, restore, and topology changes
retain full invalidation. Process-identity demand remains independent and
shares the OS process snapshot when deadlines coincide. This avoids probing
quiet split siblings and unrelated Git roots; it does not eliminate
platform-wide process enumeration.
