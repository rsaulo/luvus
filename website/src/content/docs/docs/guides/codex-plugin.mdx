...
and Devin.
Claude Code, OpenCode, Kimi Code CLI, Grok Build, Hermes CLI, Letta Code, Qwen
Code, and Kiro use their native dedicated destinations. It does not add an always-on
